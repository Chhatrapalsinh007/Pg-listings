			...
			<div class="position-relative">
				...
				<header class="dashboard-header">
					<div class="d-flex align-items-center justify-content-end">
						<h4 class="m0 d-none d-lg-block">List Of PG Owners</h4>
                        ...
                        <table class="table property-list-table">
                            ...
                            <tbody class="border-0"> 
                                ...
                                <tr>
                                    <td>
                                        <div class="d-lg-flex align-items-center position-relative">
                                            ...
                                            <div class="ps-lg-4 md-pt-10">
                                                <a href="#" class="property-name tran3s color-dark fw-500 fs-20 stretched-link">Zala Chhatrapal</a>
                                                <div class="address">Isckon, Ahmedabad , Gujarat</div>
									...
									<td>
										<div class="d-none d-md-block me-3">
											<a href="add-property.html" class="btn-two"><span>Remove Owner</span> <i class="fa-sharp fa-solid fa-trash"></i></a>
										</div>
									</td>
